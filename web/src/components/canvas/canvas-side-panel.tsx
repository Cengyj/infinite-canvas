...
function buildInsertPayload(asset: Asset): InsertAssetPayload {
    ...
    if (asset.kind === "video") return { kind: "video", url: asset.data.url, storageKey: asset.data.storageKey, title: asset.title, width: asset.data.width, height: asset.data.height, aspectRatio: asset.data.aspectRatio };
