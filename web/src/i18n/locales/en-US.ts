export default {
    ...
    grokVideo: { durationUnsupported: "Grok video duration must be between 1 and 15 seconds", aspectRatioUnsupported: "Grok video aspect ratio must be 1:1, 16:9, 9:16, 4:3, 3:4, 3:2, or 2:3", resolutionUnsupported: "Grok video quality must be 480p, 720p, or 1080p", resolutionCombinationUnsupported: "Grok 1080p quality requires a 1.5 model and no more than one reference image" },
    common: {
        cancel: "Cancel",
        save: "Save",
        edit: "Edit",
    ...
    settingsPanels: {
        ...
        video: { title: "Video settings", quality: "Quality", size: "Size", seconds: "Seconds", resolution: "Quality tier", ratio: "Aspect ratio", duration: "Duration", output: "Output", generateAudio: "Generate audio", watermark: "Add watermark", adaptive: "Adaptive", sizes: { landscape: "Landscape", portrait: "Portrait", square: "Square", widescreen: "Widescreen", tall: "Tall", auto: "Auto" }, ratios: { landscape: "Landscape", portrait: "Portrait", square: "Square", standardLandscape: "Standard landscape", standardPortrait: "Standard portrait", cinematic: "Cinematic", adaptive: "Adaptive" } },
