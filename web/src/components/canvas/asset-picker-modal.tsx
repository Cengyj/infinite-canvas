...
export type InsertAssetPayload = { kind: "text"; content: string; title: string } | { kind: "image"; dataUrl: string; title: string; storageKey?: string; mimeType?: string } | { kind: "video"; url: string; title: string; storageKey?: string; width?: number; height?: number };
...
function MyAssetsTab({ onInsert }: { onInsert: (payload: InsertAssetPayload) => void }) {
    ...
    const handleInsert = (asset: Asset) => {
        if (asset.kind === "text") {
            ...
            onInsert(asset.kind === "video" ? { kind: "video", url: asset.data.url, storageKey: asset.data.storageKey, title: asset.title, width: asset.data.width, height: asset.data.height } : { kind: "image", dataUrl: asset.data.dataUrl, storageKey: asset.data.storageKey, mimeType: asset.data.mimeType, title: asset.title });
        }
    };
